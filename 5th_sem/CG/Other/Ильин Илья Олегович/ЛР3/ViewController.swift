...
/**
 # ЛР 3
 ## Вариант 14. Усеченный прямой эллиптический цилиндр.
...
class ViewController: MetalViewController, MetalViewControllerDelegate {
    ...
    var objectToDraw: TiltCylinder!
    
    @IBOutlet weak var slider: UISlider!
    let minDelta: Float = 0.001
    let maxDelta: Float = 2
    ...
    override func viewDidLoad() {
        ...
        objectToDraw = TiltCylinder(device: device)
    ...
    func renderObjects(drawable: CAMetalDrawable) {
        objectToDraw.render(commandQueue: commandQueue, pipelineState: pipelineState, drawable: drawable, parentModelViewMatrix: worldModelMatrix, projectionMatrix: projectionMatrix, clearColor: MTLClearColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0))
    }
