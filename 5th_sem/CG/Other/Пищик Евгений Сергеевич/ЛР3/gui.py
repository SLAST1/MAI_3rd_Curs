...
def update(ent4, ent5, ent6, ent7, ent8, ent9, ent10, ent11, ent12, ent13) -> None:
    try:
        subprocess.run(f'C:/Users/jenja/anaconda3/python.exe C:\\Users\\jenja\\Downloads\\VSC\\computer_graphics\\cg_exercise_03\\draw.py {ent4.get()} {ent5.get()} {ent6.get()} {ent7.get()} {ent8.get()} {ent9.get()} {ent10.get()} {ent11.get()} {ent12.get()} {ent13.get()}')
    except Exception as _:
        subprocess.run(f'C:\\Users\\SuperPC\\anaconda3\\envs\\p39\\python.exe C:\\Users\\SuperPC\\Downloads\\VSC\\CG\\cg_exercise_03\\draw.py {ent4.get()} {ent5.get()} {ent6.get()} {ent7.get()} {ent8.get()} {ent9.get()} {ent10.get()} {ent11.get()} {ent12.get()} {ent13.get()}')
...
def main() -> None:
    ...
    lab6 = tkinter.Label(panel, text='r')
