...
| -----------       | ------------------------------------     | -------------- |
| Пивницкий Даниэль | Формализация предметной области, капитан |                |
| Ната Тимофеева    | Объединение. Написание отчёта            |                |
...
![alt text](https://github.com/SLAST1/MAI_3rd_Curs/6th_sem/AI/Lab1/1.1.png)
![alt text](https://github.com/SLAST1/MAI_3rd_Curs/6th_sem/AI/Lab1/1.2.png)


Пример 2:
---

![alt text](https://github.com/SLAST1/MAI_3rd_Curs/6th_sem/AI/Lab1/2.1.png)
![alt text](https://github.com/SLAST1/MAI_3rd_Curs/6th_sem/AI/Lab1/2.2.png)
